...
SERVICE_NAME_UPPER=INVENTORY_SERVICE
MODULE_DIR := $(abspath .)
...
OS := $(shell uname -s)
ARCH := $(shell uname -m)
GOSERVICELIB_SOURCE_CONTEXT ?= https://github.com/gorundebug/servicelib.git\#v0.2.145
RUNTIME_STRIP ?= ON
...
GOSERVICELIB_SOURCE_CONTEXT := $(DEPENDENCY_GIT_MIRROR_DOCKER_BASE)/github.com/gorundebug/servicelib.git\#v0.2.145
endif
export GOSERVICELIB_SOURCE_CONTEXT
ifneq ($(strip $(USE_LOCAL_MODULES)),1)
export INVENTORY_SERVICE_API_SOURCE_CONTEXT := $(DEPENDENCY_GIT_MIRROR_DOCKER_BASE)/github.com/gorundebug/inventory_service_api.git\#v0.2.145
export MODEL_GO_SOURCE_CONTEXT := $(DEPENDENCY_GIT_MIRROR_DOCKER_BASE)/github.com/gorundebug/model_go.git\#v0.2.145
endif
endif
